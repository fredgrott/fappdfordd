...
const Color semanticOneColor = Color.fromARGB(255, 207, 109, 117,);
const Color semanticTwoColor = Color.fromARGB(255, 219, 148, 148,);
const Color semanticThreeColor = Color.fromARGB(255, 241, 70, 70,);
